...
# ====== 核心函数 ======
def call_ai(user_prompt, system_prompt=None):
    messages = []
...
if st.session_state.step == 'input':
    ...
    with st.form("input_form"):
        ...
        skills = st.text_input("🛠️ 掌握的技能（逗号隔开）")
...
# -*- coding: utf-8 -*-
"""
网页版：大学生职业生涯 AI 规划师 (完整多轮面试版 + 侧边栏自由提问)
"""
import streamlit as st
import os
import re
...
# ====== 配置区 ======
# 注意：BAILIAN_API_KEY 需要你在 Streamlit Cloud 的 Secrets 中配置
# 如果你在本地运行，请把这里取消注释并填入你的真实 Key
